            ...
            <main>
                ...
                <div class="container">
                    <div class="row fs-6 mb-4">
                        <div class="col-12">
                            <h1 class="mb-4">Informativa</h1>
                            <p>Informativa sul trattamento dati ai sensi dell’art. 13 D.Lgs. 196/2003 (Codice Privacy) e dell’art. 13 Regolamento UE n. 2016/679 (GDPR) LEICON di Serenella Saccon, in qualità di titolare del trattamento, informa tutti gli interessati in merito alle modalità e alle finalità del trattamento dei dati.</p>
                    ...
                    <h1 class="mb-4">Cookies</h1>
                        <div class="col-12">
                            <ul>
                                <li>Premesse LEICON di Serenella Saccon, con sede legale in via delle cascine 38 in Albizzate VA, in qualità di titolare del trattamento dei dati (“Titolare”), pubblica la seguente Cookie Policy, informativa per il trattamento dei cookie utilizzati dal sito Internet raggiungibile all’URL: https://www.leicon.it (“Sito”). Per tutto quanto non previsto dalla Cookie Policy si rinvia all'informativa in materia di trattamento dati. Utilizzando il sito l'utente accetta che vengano installati sul suo dispositivo i cookie "proprietari" e "di terze parti" indicati di seguito. Disabilitando tutti o alcuni cookie, alcune funzionalità del sito potrebbero non operare correttamente.</li>
                    ...
                    <div class="row fs-6 mb-4">
                        <div class="col-12">
                        <h1 class="mb-4">Tabella cookie</h1>
